# Mayoral Tecnical Test

Aplicación elaborada para la prueba técnica de Mayoral con React. Consiste en un buscador de productos sacados de un .json. Posibilidad de vista en una columna o varias. Responsive.
